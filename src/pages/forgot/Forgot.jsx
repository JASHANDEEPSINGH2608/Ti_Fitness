    ...
    <>
      <div className="flex justify-center flex-col items-center lg:flex-row lg:items-center ">
        ...
        <div className="flex flex-col gap-2 w-1/4 justify-center">
          <h2 className="text-6xl font-bold">Recovery</h2>
          <h6 className="text-lg pb-2">Don't worry we got you</h6>
          <div className=" bg-slate-800/45 rounded-xl flex flex-col gap-2 items-center justify-center h-3/4 py-8">
            <label className="input input-bordered flex items-center gap-2">
              ...
              <input type="text" className="grow w-48" placeholder="Thapar Mail" />
            </label>
            <label className="input input-bordered flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <input type="text" className="grow w-48" placeholder="Roll Number" />
            </label>
            <button className="btn btn-wide">Recover</button>
